...
public class CrossingCount {
	...
	/**
	  ...
	  * l = destination lane
	  * 
	  * topRoad = 0, bottomRoad = 1, leftRoad = 2, rightRoad = 3;
	  * lane closest the divider have lowest index;
	  * 
	  * No restrictions on any vehicle to go in any specific direction(except itself)
	  */
	 private VehicleCount[][][][] crossingDetail;
	 
	 /** No binding due to performance reasons. Update the properties individually without violating **/
	 ...
	 public VehicleCount getCrossingDetailCount(int sourceRoad, int sourceLane, int destinationRoad, int destinationLane) {
